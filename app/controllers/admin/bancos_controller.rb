module Admin
  class BancosController < ApplicationController
    ...
    # GET /bancos.json
    def index
      @titulo = 'Lista de bancos aceptados'
      @bancos = Banco.all
    end
    ...
    def create
      ...
      respond_to do |format|
        if @banco.save
          format.html { redirect_to @banco, notice: 'Banco creado con éxito.' }
    ...
    def update
      respond_to do |format|
        if @banco.update(banco_params)
          format.html { redirect_to @banco, notice: 'Banco actualizdo con éxito.' }
    ...
    def destroy
      @banco.destroy
      respond_to do |format|
        format.html { redirect_to bancos_url, notice: 'Banco eliminado con éxito.' }
    ...
    private
      ...
      def banco_params
        params.require(:banco).permit(:id, :nombre)
      end
  end
end